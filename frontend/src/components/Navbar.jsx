...
function Navbar() {
  ...
  const [search, setSearch] = useState(
    localStorage.getItem("bookSearch") || ""
  );
  ...
  useEffect(() => {
    ...
    window.addEventListener("bookCartUpdated", onCartEvent);
    return () => {
      window.removeEventListener("storage", onCartEvent);
      window.removeEventListener("bookCartUpdated", onCartEvent);
    };
  }, []);
  ...
  const handleSearchChange = (e) => {
    ...
    window.dispatchEvent(
      new CustomEvent("bookSearch", { detail: value || "" })
    );
  };
  return (
    <>
